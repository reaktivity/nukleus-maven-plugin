...
import static org.reaktivity.maven.plugins.nukleus.internal.ast.AstAbstractMemberNode.NULL_DEFAULT;
...
import static org.reaktivity.maven.plugins.nukleus.internal.ast.AstType.INT32;
import static org.reaktivity.maven.plugins.nukleus.internal.ast.AstType.dynamicType;
...
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.OptionContext;
...
public class AstParserTest
{
    ...
    {
        NukleusParser parser = newParser("struct Person { string8 firstName = \"firstname\"; string8 lastName = \"lastname\"; }");
        Struct_typeContext ctx = parser.struct_type();
        AstStructNode actual = new AstParser().visitStruct_type(ctx);
    ...
    {
        NukleusParser parser = newParser("struct Test { string8 field = null; }");
        Struct_typeContext ctx = parser.struct_type();
        AstStructNode actual = new AstParser().visitStruct_type(ctx);
