...
public class ArrayFWTest
{
    ...
    private final ArrayFW.Builder<Varint64FW.Builder, Varint64FW> arrayByteOrderRW =
            new ArrayFW.Builder<>(new Varint64FW.Builder(), new Varint64FW(), ByteOrder.nativeOrder());

    private final ArrayFW<Varint64FW> arrayRO = new ArrayFW<>(new Varint64FW());

    private final ArrayFW<Varint64FW> arrayByteOrderRO = new ArrayFW<>(new Varint64FW(), ByteOrder.nativeOrder());
    ...
    @Test
    public void shouldBuildEmptyListWithByteOrder() throws Exception
    {
        int offset = 12;
        int limit = arrayByteOrderRW.wrap(buffer, offset, buffer.capacity())
                .build()
                .limit();
        assertEquals(offset + 4, limit);
        expected.putInt(offset, 0);
    ...
    public void shouldReadEmptyList() throws Exception
    {
        ...
        assertTrue(arrayRO.isEmpty());
        assertEquals(0, contents.size());
    }

    @Test
    public void shouldReadEmptyListWithByteOrder() throws Exception
    {
        buffer.putInt(10,  0);
        arrayByteOrderRO.wrap(buffer, 10, buffer.capacity());
        assertEquals(14, arrayByteOrderRO.limit());
        List<Long> contents = new ArrayList<Long>();
        arrayByteOrderRO.forEach(v -> contents.add(v.value()));
        assertEquals(0, contents.size());
    }
    ...
    @Test
    public void shouldMatchItems() throws Exception
    {
        final int offset = 23;
        buffer.putInt(offset, 2);
        buffer.putByte(offset + 4, (byte) 2);
        buffer.putByte(offset + 5, (byte) 4);
        arrayRO.wrap(buffer, offset, buffer.capacity());

        Varint64FW varint64FW = new Varint64FW();
        expected.putInt(offset, 1);
        expected.putByte(offset + 4, (byte) 2);
        varint64FW.wrap(expected, offset + 4, expected.capacity());
        Predicate<Varint64FW> varint64FWPredicate = p -> {
            return p.value() == varint64FW.value();
        };
        assertTrue(arrayRO.anyMatch(varint64FWPredicate));
    }

    @Test
    public void shouldNotMatchItems() throws Exception
    {
        final int offset = 23;
        buffer.putInt(offset, 2);
        buffer.putByte(offset + 4, (byte) 2);
        ...
        Varint64FW varint64FW = new Varint64FW();
        expected.putInt(offset, 1);
        expected.putByte(offset + 4, (byte) 3);
        varint64FW.wrap(expected, offset + 5, expected.capacity());
        Predicate<Varint64FW> varint64FWPredicate = p -> {
            return p.value() == varint64FW.value();
        };
        assertFalse(arrayRO.anyMatch(varint64FWPredicate));
    }

    @Test
    public void shouldMatchFirstItem() throws Exception
    {
        final int offset = 23;
        buffer.putInt(offset, 2);
        buffer.putByte(offset + 4, (byte) 2);
        ...
        assertEquals(varint64FW.value(), arrayRO.matchFirst(varint64FWPredicate).value());
    }

    @Test
    public void shouldNotMatchFirstItem() throws Exception
    {
        final int offset = 23;
        buffer.putInt(offset, 2);
        buffer.putByte(offset + 4, (byte) 2);
        ...
        assertNull(arrayRO.matchFirst(varint64FWPredicate));
    }
    ...
    public void shouldDisplayAsString() throws Exception
    {
        ...
        ArrayFW<Varint64FW> array = arrayRW.wrap(buffer, offset, buffer.capacity())
                ...
                .item(b -> b.set(123L))
                .build();
        assertTrue(array.toString().equals("ARRAY containing 4 bytes of data"));
    }
