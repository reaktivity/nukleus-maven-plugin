...
public class OptFlatFWTest
{
    ...
    private final OptFlatFW.Builder flatRW = new OptFlatFW.Builder();
    private final OptFlatFW flatRO = new OptFlatFW();
    ...
    public void shouldProvideTypeId() throws Exception
    {
        ...
        assertEquals(0x10000001, OptFlatFW.TYPE_ID);
    ...
    {
        OptFlatFW.Builder builder = flatRW.wrap(buffer, 0, buffer.capacity());
        builder.fixed1(10)
               .fixed2(20);
