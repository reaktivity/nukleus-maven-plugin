...
public final class ConstrainedMapFW<V extends Flyweight> extends MapFW<VariantEnumKindOfStringFW, V>
{
    ...
    @Override
    public void forEach(
        BiConsumer<VariantEnumKindOfStringFW, V> consumer)
    {
    ...
    {
        return String.format("ConstrainedMapFW[%d, %d]", variantOfMapRO.get().length(), variantOfMapRO.get().fieldCount());
    }

    public static final class Builder<V extends Flyweight, VB extends Flyweight.Builder<V>> extends
        MapFW.Builder<ConstrainedMapFW<V>, VariantEnumKindOfStringFW, V, VariantEnumKindOfStringFW.Builder, VB>
    {
        ...
        @Override
        public ConstrainedMapFW.Builder<V, VB> wrap(
        ...
        @Override
        public ConstrainedMapFW.Builder<V, VB> entry(
        ...
        @Override
        public ConstrainedMapFW.Builder<V, VB> entries(
            DirectBuffer buffer,
            int index,
            int length,
            int fieldCount)
        {
            variantOfMapRW.entries(buffer, index, length, fieldCount);
            limit(variantOfMapRW.limit());
            return this;
        }
