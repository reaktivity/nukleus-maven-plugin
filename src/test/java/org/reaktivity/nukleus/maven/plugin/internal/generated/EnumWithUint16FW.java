...
public final class EnumWithUint16FW extends Flyweight
{
    ...
    private static final int FIELD_SIZE_VALUE = BitUtil.SIZE_OF_SHORT;
    ...
    {
        return EnumWithUint16.valueOf(buffer().getShort(offset() + FIELD_OFFSET_VALUE) & 0xFFFF);
    }
    ...
    public static final class Builder extends Flyweight.Builder<EnumWithUint16FW>
    {
            ...
            EnumWithUint16 value)
        {
            ...
            checkLimit(newLimit, maxLimit());
            buffer.putShort(offset, (short) (value.value() & 0xFFFF));
            limit(newLimit);
            valueSet = true;
            return this;
        }
