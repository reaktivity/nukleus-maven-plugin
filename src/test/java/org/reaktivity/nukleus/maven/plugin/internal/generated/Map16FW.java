...
public final class Map16FW<KV extends Flyweight, VV extends Flyweight> extends MapFW<KV, VV>
{
    ...
    public static final class Builder<KB extends Flyweight.Builder<KV>, KV extends Flyweight,
        VB extends Flyweight.Builder<VV>, VV extends Flyweight> extends MapFW.Builder<Map16FW, KB, KV, VB, VV>
    {
        public Builder(
            KB keyRW,
            KV keyRO,
            ...
            VV valueRO)
        {
            super(new Map16FW<>(keyRO, valueRO), keyRW, valueRW);
        }
