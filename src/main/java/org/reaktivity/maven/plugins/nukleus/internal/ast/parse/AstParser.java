 ...
 * under the License.
 */
package org.reaktivity.maven.plugins.nukleus.internal.ast.parse;

import static org.reaktivity.maven.plugins.nukleus.internal.ast.AstByteOrder.NATIVE;
import static org.reaktivity.maven.plugins.nukleus.internal.ast.AstByteOrder.NETWORK;
...
import org.reaktivity.maven.plugins.nukleus.internal.ast.AstListMemberNode;
import org.reaktivity.maven.plugins.nukleus.internal.ast.AstListNode;
import org.reaktivity.maven.plugins.nukleus.internal.ast.AstListNode.Builder;
...
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusBaseVisitor;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Array_keywordContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Array_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Case_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.DeclaratorContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Default_nullContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Defined_variant_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Defined_variant_member_with_parametric_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Enum_member_with_defaultContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Enum_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Enum_valueContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int16_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int24_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int32_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int64_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int8_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int_literalContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Int_member_with_defaultContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Integer_array_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.KindContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.List_keywordContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.List_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.List_paramsContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.List_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.List_usingContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Map_keywordContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Map_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.MemberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Member_with_parametric_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Non_primitive_member_with_defaultContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Octets_keywordContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Octets_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.OptionByteOrderContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.ScopeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Scoped_nameContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.SpecificationContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String16_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String32_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String8_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String_literalContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String_member_with_defaultContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String_member_with_null_defaultContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.String_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Struct_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Type_idContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Typedef_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint16_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint24_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint32_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint64_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint8_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint_literalContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Uint_member_with_defaultContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Unbounded_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Unbounded_octets_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Union_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Varbyteuint32_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_array_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_case_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_case_member_no_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_case_member_without_ofContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_case_valueContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_int_literalContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_list_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_map_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_octets_memberContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_of_typeContext;
import org.reaktivity.maven.plugins.nukleus.internal.parser.NukleusParser.Variant_typeContext;
...
public final class AstParser extends NukleusBaseVisitor<AstNode>
{
    ...
    @Override
    public AstNode visitVarbyteuint32_type(
        Varbyteuint32_typeContext ctx)
    {
        memberBuilder.type(AstType.VARBYTEUINT32);
        return super.visitVarbyteuint32_type(ctx);
    }
