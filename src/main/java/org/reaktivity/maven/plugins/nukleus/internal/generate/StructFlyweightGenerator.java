...
import static org.reaktivity.maven.plugins.nukleus.internal.generate.TypeNames.BUFFER_UTIL_TYPE;
import static org.reaktivity.maven.plugins.nukleus.internal.generate.TypeNames.BYTE_ARRAY;
import static org.reaktivity.maven.plugins.nukleus.internal.generate.TypeNames.DIRECT_BUFFER_TYPE;
import static org.reaktivity.maven.plugins.nukleus.internal.generate.TypeNames.MUTABLE_DIRECT_BUFFER_TYPE;
import static org.reaktivity.maven.plugins.nukleus.internal.generate.TypeNames.UNSAFE_BUFFER_TYPE;
...
import org.reaktivity.maven.plugins.nukleus.internal.ast.AstNamedNode.Kind;
    ...
    private static final class BuilderClassGenerator extends ClassSpecGenerator
    {
            ...
            TypeResolver resolver)
        {
            ...
            if (typeName instanceof ClassName && !isStringType((ClassName) typeName) && !isVarintType(typeName) &&
                !isVaruintType(typeName) && !isEnumType)
            {
        ...
        private static final class MemberFieldGenerator extends ClassSpecMixinGenerator
        {
            ...
            public MemberFieldGenerator addMember(
                ...
                AstByteOrder byteOrder)
            {
                if (usedAsSize && (isVarintType(type) || isVaruintType(type)))
                {
        ...
        private static final class MemberAccessorGenerator extends ClassSpecMixinGenerator
        {
                ...
                Consumer<CodeBlock.Builder> defaultPriorField)
            {
                ...
                priorFieldIsAutomaticallySet = usedAsSize && !isVarintType(type) && !isVaruintType(type);
                return this;
            }
        ...
        private static final class MemberMutatorGenerator extends ClassSpecMixinGenerator
        {
                ...
                Consumer<CodeBlock.Builder> defaultPriorField)
            {
                ...
                else
                {
                    ...
                    String parameterName = isVarintType(className) || isVaruintType(className) ? "value" : "mutator";
                    ...
                    if (isVarintType(className) || isVaruintType(className))
                    {
                ...
                Object defaultValue)
            {
                ...
                else if (sizeName != null)
                {
                    ...
                    if (isVarintType(sizeType) || isVaruintType(sizeType))
                    {
