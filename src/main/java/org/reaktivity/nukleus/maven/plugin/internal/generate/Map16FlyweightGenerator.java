...
public final class Map16FlyweightGenerator extends ClassSpecGenerator
{
    ...
    private MethodSpec forEachMethod()
    {
        ...
        return methodBuilder("forEach")
            ...
            .beginControlFlow("for (int i = 0; i < fieldCount() / 2; i++)")
    ...
    private static final class BuilderClassBuilder
    {
            ...
            ClassName flyweightType)
        {
            ...
            this.typeVarVB = TypeVariableName.get("VB", ParameterizedTypeName.get(variantBuilderType, typeVarVV, typeVarVK,
                typeVarVO));
            TypeName parameterizedMapBuilderType = ParameterizedTypeName.get(mapBuilderType, map16Type, typeVarKB, typeVarKV,
                typeVarKK, typeVarKO, typeVarVB, typeVarVV, typeVarVK, typeVarVO);

            this.parameterizedBuilderType = ParameterizedTypeName.get(map16BuilderType, typeVarKB, typeVarKV, typeVarKK,
