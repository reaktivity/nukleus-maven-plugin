...
public final class String16FlyweightTestGenerator extends ClassSpecGenerator
{
    ...
    {
        return FieldSpec.builder(string16FlyweightClassName, "stringRO", PUBLIC)
                .build();
    }

    private FieldSpec fieldString16Builder()
    {
        return FieldSpec.builder(string16FlyweightBuilderClassName, "stringRW", PUBLIC)
            .build();
    }
    ...
    private FieldSpec fieldBuffer()
    {
        ...
        return FieldSpec.builder(MutableDirectBuffer.class, "buffer", PRIVATE, FINAL)
            .initializer("new org.agrona.concurrent.UnsafeBuffer(java.nio.ByteBuffer.allocateDirect(100000)) \n" +
                "{\n"+
                "    {\n"+
