...
import org.reaktivity.nukleus.maven.plugin.internal.ast.*;
...
public final class UnionTestVisitor extends AstNode.Visitor<Collection<TypeSpecGenerator<?>>>
{
    private final UnionFlyweightTestGenerator generator;
    private final TypeResolver resolver;
    private final Set<TypeSpecGenerator<?>> defaultResult;

    public UnionTestVisitor(
        UnionFlyweightTestGenerator generator,
